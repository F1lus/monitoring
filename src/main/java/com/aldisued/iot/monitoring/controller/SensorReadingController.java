...
public class SensorReadingController {
  ...
  public SensorReadingController(final SensorReadingService sensorReadingService) {
    this.sensorReadingService = sensorReadingService;
  }

  @PostMapping
  public SensorReading saveSensorReading(@RequestBody @Valid SensorReadingDto sensorReadingDto) {
